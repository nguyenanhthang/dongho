const productHotProduct = document.querySelector('.wrapper-product-product-men');
const newWatchHotProduct = watchHot.forEach((n) => {
    if(productHotProduct) {
    productHotProduct.innerHTML += `
